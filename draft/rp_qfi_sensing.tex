...
\textbf{Why constructed rather than cited.} A systematic search~\cite{ornelas2026fem} of the
bridge's four required pieces found each published separately --- gravity entering a lattice as a
